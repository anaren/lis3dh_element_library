...
{
  uint16_t returnData = (uint16_t)LIS3DH_ReadReg(LIS3DH_OUT_X_H_REG_ADDR) << 8;
...
{
  uint16_t returnData = (uint16_t)LIS3DH_ReadReg(LIS3DH_OUT_Y_H_REG_ADDR) << 8;
...
{
  uint16_t returnData = (uint16_t)LIS3DH_ReadReg(LIS3DH_OUT_Z_H_REG_ADDR) << 8;
